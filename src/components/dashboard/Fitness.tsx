...
import { 
  Dumbbell, AlertTriangle, Calendar, CheckCircle, 
  PlayCircle, Trophy, RotateCcw, LayoutGrid, Loader2, Plus,
  Activity, Timer, Zap, HeartPulse, Lock
} from "lucide-react";
...
export default function Fitness({ user, isWorkoutDone, hasActivePlan }: FitnessProps) {
